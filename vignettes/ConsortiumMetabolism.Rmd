...
- **Six assay matrices** (square, metabolite-by-metabolite, sparse):
  Binary, nEdges, Consumption, Production, EffectiveConsumption,
  EffectiveProduction
- **Edge data** linking consumed and produced metabolites with per-edge
  summary statistics
...
Returns the edge data.frame, which contains per-edge summary
...
| Assay | Content |
|-------|---------|
| Binary | 1 if an edge exists, 0 otherwise |
| nEdges | Number of species catalysing the edge |
