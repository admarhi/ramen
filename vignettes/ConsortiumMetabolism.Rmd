...
## Available Methods 
- `consortia()`: Returns the community in tibble format.
- `species()`: Retrieves the species from a community.
- `metabolites()`: Retrieves metabolites from a community.
- `getFlux()`: Retrieves the fluxes from a community.
- `pathways()`: Retrieves the edges from a community.
