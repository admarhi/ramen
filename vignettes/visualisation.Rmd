...
the usual `ggplot2` operators (e.g. `+ ggplot2::theme_minimal()`).
Network plots are rendered with the `ggraph` package.
...
`ggraph`. Nodes are coloured by role: **lightblue** for sources
