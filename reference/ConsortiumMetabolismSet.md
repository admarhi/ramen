...
- `OverlapMatrix`:
  ...
  matrix. Pairwise Functional Overlap Score (FOS, Szymkiewicz-Simpson)
  between consortia. Diagonal is 1 (self-overlap); higher values mean
  more shared pathways.
...
#> ✔ Re-indexing 7 unique metabolites [34ms]
#> 
...
#> Pathways: 2 pan-cons, 12 niche, 1 core, 10 aux (quantileCutoff = 0.1; buckets
#> may overlap, see ?pathways).
#> Species: 1 generalists, 3 specialists (quantileCutoff = 0.15).
```
