...
#> ✔ Expanding 2 binary matrices to 5-dimensional space [24ms]
#> 
...
#> CMS "demo" created: 2 consortia, 5 metabolites (0.2s)
...
#> Name: "a"
#> Weighted metabolic network: 3 species, 2 metabolites, 3 pathways.
#> Pathways per species: min 1, mean 1, max 1.
#> 
#> [[2]]
#> 
#> ── ConsortiumMetabolism 
...
#> Pathways per species: min 1, mean 1.7, max 2.
#> 
```
