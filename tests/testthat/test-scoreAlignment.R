...
#   a1 <- ConsortiumMetabolismAlignment(
#     ConsortiumMetabolism(tb1, name = "t1"),
#     ConsortiumMetabolism(tb1, name = "t2"),
#     name = "test"
#   )
#   s1 <- a1@Score
...
#     purrr::imap(ConsortiumMetabolism) %>%
#     ConsortiumMetabolismAlignment(name = "test")
#   s2 <- a2@Score
...
#     purrr::imap(ConsortiumMetabolism)
#
#   a3 <- ConsortiumMetabolismAlignment(l3, name = "test")
#   s3 <- a3@Score
#   expect_equal(nrow(s3), 2)
#   expect_contains(s3$score, 1 / 6)
#
#   a3.1 <- ConsortiumMetabolismAlignment(l3[1:2], name = "test")
#   s3.1 <- a3.1@Score
